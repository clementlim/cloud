...
$my_email = "clement@clementlim.tel";
...
$subject = "clementlim.com message";
...
<head>
<?php require_once('my_alert/my_alert.php');
my_alert_head(); ?>

<title>Clement Lim Message Form</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<body bgcolor="#ffffff" text="#000000">
<?php my_alert_body(); ?>
<?php my_alert('Message Status', 'Message is sent', 1, 'http://www.clementlim.com'); ?>
</body>
</html>